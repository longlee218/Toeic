            ...
            <div class="card">
                ...
                <article class="card-body">
                    <form method="post" id="login_form">
                        ...
                        <div class="form-group">
                            <button type="submit" name="login_button" id='login_btn' class="btn btn-outline-primary "> Đăng nhập </button>
                            <button onclick="loginGoogle()" type="button" name="google_button" id='google_btn' class="btn btn-outline-danger"> Đăng nhập với Google </button>
                        </div> <!-- form-group// -->
                    </form>
                </article>
            </div> <!-- card.// -->
...
//
    ...
    function loginGoogle(){
        $.ajax({
            method: 'GET',
            url: '/../Toeic/API/APILogin/urlGoogle',
            success: (data) =>{
